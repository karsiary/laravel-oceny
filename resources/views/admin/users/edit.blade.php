...
@section('content')
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        <div class="flex justify-between items-center mb-6">
            <h2 class="text-2xl font-semibold text-white">Edytuj Użytkownika</h2>
        ...
        <div class="bg-[rgb(30,41,59,0.5)] rounded-lg p-6">
            <form action="{{ route('admin.users.update', $user) }}" method="POST" class="space-y-6">
                ...
                <div>
                    <label for="password" class="block text-sm font-medium text-white">Hasło (zostaw puste, aby nie zmieniać)</label>
